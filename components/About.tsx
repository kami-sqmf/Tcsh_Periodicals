...
function About({ className, data }: {className: string, data: {email: string, insta: string, description : string;}}) {
    return (
        <div className={`${className} max-w-full h-max border-2 border-main px-6 md:px-8 mt-8 md:mt-0 mb-8 md:mb-0 md:h-[532px]`}>
            ...
            <p className="mt-8 text-lg md:text-base xl:text-lg text-gray-700">{data.description}</p>
            ...
            <div className="flex flex-col mt-9 md:mt-4 lg:mt-9 mb-8 space-y-6 md:space-y-2 lg:space-y-6">
                <Link href={`https://www.instagram.com/${data.insta}`}>
