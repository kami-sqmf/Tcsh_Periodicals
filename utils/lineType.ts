...
export interface LineRequestEvents extends Array<RequestEvent> { }

type RequestEvent = MessageEvent | UnsendEvent | FollowEvent | UnfollowEvent | JoinEvent | LeaveEvent | MemberJoinEvent | MemberLeaveEvent | PostbackEvent | VideoPlayCompleteEvent | BeaconEvent | AccountLinkEvent | DeviceLinkEvent | DeviceUnlinkEvent | LINEThingsScenarioExecutionEvent;
...
interface ReplyableEvent extends EventBase {
    replyToken: string
}
 ...
 */
export interface MessageEvent extends ReplyableEvent {
    type: "message";
...
interface EventMessageBase { id: string };
...
export interface TextEventMessage extends EventMessageBase {
    type: "text";
    text: string;
    /**
...
export interface ImageEventMessage extends EventMessageBase {
    type: "image";
...
export interface VideoEventMessage extends EventMessageBase {
    type: "video";
    contentProvider: ContentProvider;
}

export interface AudioEventMessage extends EventMessageBase {
    type: "audio";
    duration: number;
    contentProvider: ContentProvider<false>;
}

export interface LocationEventMessage extends EventMessageBase {
    type: "location";
    title: string;
    address: string;
    latitude: number;
...
export interface FileEventMessage extends EventMessageBase {
    type: "file";
    fileName: string;
    fileSize: string;
}

export interface StickerEventMessage extends EventMessageBase {
    type: "sticker";
    packageId: string;
    stickerId: string;
    stickerResourceType:
 ...
 */
interface RichMenuSwitchPostback {
 ...
 */
export interface FollowEvent extends ReplyableEvent {
    type: "follow"
}
 ...
 */
export interface UnsendEvent extends EventBase {
    type: "unsend";
 ...
 *     added.
 */
interface JoinEvent extends ReplyableEvent {
    type: "join"
}

interface LeaveEvent extends EventBase {
    type: "leave"
}

interface MemberJoinEvent extends ReplyableEvent {
    type: "memberJoined";
    /**
...
interface MemberLeaveEvent extends EventBase {
    type: "memberLeft";
    /**
...
interface VideoPlayCompleteEvent extends ReplyableEvent {
...
interface BeaconEvent extends ReplyableEvent {
    type: "beacon";
    beacon: {
 ...
 */
interface AccountLinkEvent extends ReplyableEvent {
    type: "accountLink";
    link: {
        result: "ok" | "failed";
 ...
 */
interface DeviceLinkEvent extends ReplyableEvent {
    type: "things";
    things: {
        /**
 ...
 */
interface DeviceUnlinkEvent extends ReplyableEvent {
    type: "things";
    things: {
        /**
...
interface LINEThingsScenarioExecutionEvent extends ReplyableEvent {
    type: "things";
    things: {
        type: "scenarioResult";
        /**
...
interface LINEThingsActionResult {
    /**
     * `void`, `binary`
