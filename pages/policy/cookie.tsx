...
const CookiePolicy = () => {
  ...
  return (
    <PageWrapper lang={lang} page={Global.webMap.policy.child.cookie} withNavbar={true} operating={false}>
      <Breadcrumb args={[{ title: Global.webMap.policy.title(lang), href: "/policy", icon: RiAttachment2 }, { title: Global.webMap.policy.child.cookie.title(lang), href: "/policy/cookie", icon: Global.webMap.policy.child.cookie.nav.icon }]} />
      <div className="relative flex flex-col text-main mt-6 prose-h1:font-black prose-h1:text-4xl prose-h1:mb-4 prose-h2:font-bold prose-h2:text-xl prose-h2:mb-2 prose-h3:font-semibold prose-h3:text-base prose-h4:ml-4 prose-h4:font-normal prose-h4:text-base prose-h5:indent-4 prose-h5:ml-4 prose-h5:mb-3 prose-h5:font-normal prose-h5:text-base prose-a:text-main2">
        ...
        {content[lang === "zh" ? "zh" : "en"].map((content, key) => {
          const render: any[] = [];
          if (content.link) {
