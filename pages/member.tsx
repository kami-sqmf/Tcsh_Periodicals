...
import { getProps_Global_Members_DB } from "../utils/get-firestore"
...
const Member = ({ data, members, lang }: InferGetStaticPropsType<typeof getProps_Global_Members_DB>) => {
    ...
    return (
        <PageWrapper lang={lang} page={Global.webMap.member} withNavbar={true} operating={false} Noti={data.Notification}>
