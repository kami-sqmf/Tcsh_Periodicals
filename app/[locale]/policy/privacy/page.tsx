...
export default async function Page({ params }: { params: { locale: LangCode } }) {
  return (
    <>
      <BreadcrumbServerWrapper args={[{ title: webInfo.webMap.policy.title(await params.locale) as string, href: webInfo.webMap.policy.href, icon: webInfo.webMap.policy.nav.icon }, { title: webInfo.webMap.policy.child.privacy.title(await params.locale) as string, href: webInfo.webMap.policy.child.privacy.href, icon: webInfo.webMap.policy.child.privacy.nav.icon }]} />
